...
# display_airbus_plane, list_helis, list_planes, airbus_rest_plane, filter_heli_list, filter_plane_list,\
#     display_gulfstream_plane, display_boeing_plane, display_bluebook_plane, display_bluebook_heli
